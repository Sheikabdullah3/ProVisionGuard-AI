"""
ProVisionGuard AI v5.0 — Crash-proof edition
=============================================
Fixes:
  - Camera opens AFTER Flask is ready
  - All AI loads in background thread safely  
  - Browser never reloads/crashes
  - GPU auto-detect (works with CPU too)
  - cv2.imshow disabled by default (headless mode)
    Set SHOW_WINDOW = True if you want camera popup

Run:   python app_v5.py
...
# ── SETTINGS ──────────────────────────────────────────────
SHOW_WINDOW   = True   # Set True to see camera popup
...
<header id="hdr">
  ...
  <div><div class="bnm">ProVisionGuard</div><div class="bvr">ENTERPRISE AI v5.0</div></div>
  <div class="hd"></div>
  <div class="hmet">
...
<footer id="ftr">
  ...
  <div class="fi">v<span>5.0</span></div>
...
if __name__ == '__main__':
    print("\n" + "="*52)
    print("  ProVisionGuard AI — Enterprise v5.0")
    print("="*52)
